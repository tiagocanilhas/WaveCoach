...
class WaterActivityControllerTest {
    ...
    fun `add wave - success`() {
        ...
        client.post().uri("/water/$FIRST_ACTIVITY_ID/wave")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
            ...
            .expectHeader().exists("Location")
            .expectHeader().value("location") {
                assertTrue(it.startsWith("/api/water/$FIRST_ACTIVITY_ID/wave/"))
            }
    }

    @Test
    fun `add wave - unauthorized`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add wave - invalid water activity id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add wave - water activity not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    fun `add wave - not water activity`() {
        ...
        client.post().uri("/water/$NOT_WATER_ACTIVITY_ID/wave")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add wave - user is not a coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    fun `remove wave - success`() {
        ...
        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/1")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isNoContent
    }
    ...
    @Test
    fun `remove wave - invalid water activity id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = "invalid"

        client.delete().uri("/water/$id/wave/1")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove wave - invalid wave id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = "invalid"

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/$id")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
            .expectBody()
            .jsonPath("type").isEqualTo(Problem.invalidWaveId.type.toString())
    }

    @Test
    fun `remove wave - water activity not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    fun `remove wave - not water activity`() {
        ...
        client.delete().uri("/water/$NOT_WATER_ACTIVITY_ID/wave/1")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove wave - user is not a coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `remove wave - wave is not part of water activity`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/3")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
            .expectBody()
            .jsonPath("type").isEqualTo(Problem.notActivityWave.type.toString())
    }

    /**
     * Add maneuver to wave Test
     */

    @Test
    fun `add maneuver to wave - success`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$FIRST_ACTIVITY_ID/wave/$SECOND_WAVE_ID/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
            ...
            .expectHeader().exists("Location")
            .expectHeader().value("location") {
                assertTrue(it.startsWith("/api/water/$FIRST_ACTIVITY_ID/wave/2/maneuver/"))
            }
    }

    @Test
    fun `add maneuver to wave - unauthorized`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add maneuver to wave - invalid water activity id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$id/wave/$SECOND_WAVE_ID/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add maneuver to wave - invalid wave id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$FIRST_ACTIVITY_ID/wave/$id/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add maneuver to wave - water activity not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add maneuver to wave - not athletes coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add maneuver to wave - wave not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$FIRST_ACTIVITY_ID/wave/0/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add maneuver to wave - invalid order`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add maneuver to wave - invalid water maneuver`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `add maneuver to wave - not water activity`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$NOT_WATER_ACTIVITY_ID/wave/$SECOND_WAVE_ID/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add maneuver to wave - not activity wave`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
        ...
        client.post().uri("/water/$FIRST_ACTIVITY_ID/wave/3/maneuver")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(body)
            .exchange()
    ...
    @Test
    fun `add maneuver to wave - user is not a coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    /**
     * Remove maneuver from wave Test
     */

    @Test
    fun `remove maneuver from wave - success`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$SECOND_ACTIVITY_ID/wave/$THIRD_WAVE_ID/maneuver/4")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isNoContent
    }
    ...
    @Test
    fun `remove maneuver from wave - unauthorized`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `remove maneuver from wave - invalid water activity id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = "invalid"

        client.delete().uri("/water/$id/wave/$THIRD_WAVE_ID/maneuver/4")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - invalid wave id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = "invalid"

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/$id/maneuver/3")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - invalid maneuver id`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = "invalid"

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/$SECOND_WAVE_ID/maneuver/$id")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
            .expectBody()
            .jsonPath("type").isEqualTo(Problem.invalidManeuverId.type.toString())
    }

    @Test
    fun `remove maneuver from wave - water activity not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `remove maneuver from wave - not athletes coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/$SECOND_WAVE_ID/maneuver/3")
            .header("Authorization", "Bearer $SECOND_COACH_TOKEN")
            .exchange()
            .expectStatus().isForbidden
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - wave not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()
    ...
    @Test
    fun `remove maneuver from wave - maneuver not found`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        val id = 0

        client.delete().uri("/water/$SECOND_ACTIVITY_ID/wave/$THIRD_WAVE_ID/maneuver/$id")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isNotFound
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - not water activity`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$NOT_WATER_ACTIVITY_ID/wave/$SECOND_WAVE_ID/maneuver/3")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - not activity's wave`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$FIRST_ACTIVITY_ID/wave/$THIRD_WAVE_ID/maneuver/4")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
    ...
    @Test
    fun `remove maneuver from wave - not wave's maneuver`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$SECOND_ACTIVITY_ID/wave/$THIRD_WAVE_ID/maneuver/2")
            .header("Authorization", "Bearer $FIRST_COACH_TOKEN")
            .exchange()
            .expectStatus().isBadRequest
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
            .expectBody()
            .jsonPath("type").isEqualTo(Problem.notWaveManeuver.type.toString())
    }

    @Test
    fun `remove maneuver from wave - user is not a coach`() {
        val client = WebTestClient.bindToServer().baseUrl(BASE_URL).build()

        client.delete().uri("/water/$SECOND_ACTIVITY_ID/wave/$THIRD_WAVE_ID/maneuver/3")
            .header("Authorization", "Bearer $FIRST_ATHLETE_TOKEN")
            .exchange()
            .expectStatus().isForbidden
            .expectHeader().contentType(MediaType.APPLICATION_PROBLEM_JSON)
