...
insert into waveCoach.user (username, password) values ('athlete', '$2a$10$6wZjBBzU2G1H7rK5VeFNIu.toyRHL.ULP1R2IMjpPy7xB8HhF/h0q');
 -- password: Admin123!
insert into waveCoach.athlete (uid, coach, name, birthdate) values (3, 1, 'John Doe', 631152000);
...
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (1, 50.0, 12, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (1, 55.0, 10, 60.0, 2);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (1, 60.0, 8, 60.0, 3);
insert into waveCoach.exercise (activity, exercise, exercise_order) values (1, 4, 2);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (2, 40.0, 10, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (2, 50.0, 6, 90.0, 2);
insert into waveCoach.exercise (activity, exercise, exercise_order) values (1, 8, 3);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (3, 45.0, 12, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (3, 45.0, 12, 60.0, 2);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (3, 45.0, 12, 60.0, 3);
insert into waveCoach.exercise (activity, exercise, exercise_order) values (1, 12, 4);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (4, 10.0, 15, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (4, 10.0, 15, 60.0, 2);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (4, 10.0, 15, 60.0, 3);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (4, 10.0, 15, 60.0, 4);
insert into waveCoach.exercise (activity, exercise, exercise_order) values (1, 13, 5);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (5, 10.0, 15, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (5, 10.0, 15, 60.0, 2);
insert into waveCoach.exercise (activity, exercise, exercise_order) values (1, 2, 6);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (6, 10.0, 15, 60.0, 1);
insert into waveCoach.set (exercise_id, weight, reps, rest_time, set_order) values (6, 10.0, 15, 60.0, 2);


INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 1, 1746144000000); -- 2025-05-02
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (2, 5, 'Good', 120, 60);
INSERT INTO waveCoach.wave (activity, points, right_side, wave_order) VALUES (2, 5, true, 1);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (9, 5, 'Good', 118, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (11, 7, 'Good', 120, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 4, 1749513600000); -- 2025-06-10
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (12, 8, 'Good', 125, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 4, 1749600000000); -- 2025-06-11
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (13, 9, 'Good', 130, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (15, 7, 'Good', 115, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 5, 1750118400000); -- 2025-06-17
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (16, 6, 'Good', 120, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 5, 1750204800000); -- 2025-06-18
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (17, 5, 'Good', 125, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (20, 7, 'Good', 110, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 6, 1751587200000); -- 2025-07-04
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (21, 6, 'Good', 115, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 6, 1751673600000); -- 2025-07-05
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (22, 5, 'Good', 120, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (24, 8, 'Good', 115, 5400);

INSERT INTO waveCoach.activity (uid, microcycle, date) VALUES (3, 7, 1752700800000); -- 2025-07-16
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (25, 9, 'Good', 120, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (27, 7, 'Good', 125, 5400);
...
INSERT INTO waveCoach.water (activity, rpe, condition, trimp, duration) VALUES (28, 8, 'Good', 107, 5400);

INSERT INTO waveCoach.wave (activity, points, right_side, wave_order) VALUES (28, 5, true, 1);
INSERT INTO waveCoach.maneuver (wave, maneuver, success, maneuver_order) VALUES (3, 1, true, 1);
INSERT INTO waveCoach.maneuver (wave, maneuver, success, maneuver_order) VALUES (3, 1, true, 2);
INSERT INTO waveCoach.maneuver (wave, maneuver, success, maneuver_order) VALUES (3, 1, true, 3);
...
-- password: Admin123!
insert into waveCoach.athlete (uid, coach, name, birthdate, credentials_changed) values (4, 2, 'Jane Doe', 631152000, true);
...
-- password: Admin123!
insert into waveCoach.athlete (uid, coach, name, birthdate) values (5, 2, 'John Smith', 631152000);
...
-- password: Admin123!
insert into waveCoach.athlete (uid, coach, name, birthdate) values (6, 2, 'Jane Smith', 631152000);

--Fifth Athlete
insert into waveCoach.user (username, password) values ('athlete5', '$2a$10$6wZjBBzU2G1H7rK5VeFNIu.toyRHL.ULP1R2IMjpPy7xB8HhF/h0q');
-- password: Admin123!
insert into waveCoach.athlete (uid, coach, name, birthdate) values (7, 1, 'Alice Johnson', 631152000);

--Third Coach
insert into waveCoach.user (username, password) values ('user3', '$2a$10$6wZjBBzU2G1H7rK5VeFNIu.toyRHL.ULP1R2IMjpPy7xB8HhF/h0q');
-- password: Admin123!
...
-- First Competition
insert into waveCoach.competition (uid, date, location, place, name) values (3, 1746057600000, 'Ocean Beach', 1, 'Spring Surf Contest');
insert into waveCoach.activity (uid, microcycle, date) values (3, 1, 1746057600000); -- 2025-05-01
...
insert into waveCoach.maneuver (wave, maneuver, success, maneuver_order) values (9, 1, true, 1);
insert into waveCoach.heat (competition, water_activity, score) values (1, 29, 85);

-- Second Competition
insert into waveCoach.competition (uid, date, location, place, name) values (3, 1746144000000, 'Ocean Beach', 2, 'Summer Surf Contest');
